--/*
--############################################################################################################################
--# File Name      : swi_load_stg_cus_cdfreqtrvlsrc.sql
--# Description    : This script loads the swi_stg_cus_cdfreqtrvlsrc stage table in  aw_stg_bus_dbo database using file  
--#	         		 /temp/starwood/CUS_CDFREQTRVLSRC_SW_201609.dat.
--#
--# Change history
...
--# Loading swi_stg_cus_cdfreqtrvlsrc stage table in  aw_stg_bus_dbo database using file /temp/starwood/CUS_CDFREQTRVLSRC_SW_201609.dat

LOAD HADOOP USING FILE 
URL '/temp/starwood/CUS_CDFREQTRVLSRC_SW_201609.dat'
...
INTO TABLE aw_stg_bus_dbo.swi_stg_cus_cdfreqtrvlsrc OVERWRITE
