--/*
--############################################################################################################################
--# File Name      : swi_load_stg_cus_cdactionreason.sql
--# Description    : This script loads the swi_stg_cus_cdactionreason stage table in  aw_stg_bus_dbo database using file  
--#	         		 /temp/starwood/CUS_CDACTIONREASON_SW_201609.txt.
--#
--# Change history
...
--# Loading swi_stg_cus_cdactionreason_temp table in  aw_stg_bus_dbo database using file /temp/starwood/CUS_CDACTIONREASON_SW_201609.txt

LOAD HADOOP USING FILE 
URL '/temp/starwood/CUS_CDACTIONREASON_SW_201609.txt'
...
INTO TABLE aw_stg_bus_dbo.swi_stg_cus_cdactionreason OVERWRITE
